...
const CONFIG = {
    ...
    valentineName: "Stiina",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "super tärkeä kysymys💝🐻💗💗💗💗💗",
    ...
    questions: {
        first: {
            ...
            yesBtn: "JOOO",                                             // Text for "Yes" button
            noBtn: "En...",                                               // Text for "No" button
            secretAnswer: "en pelkästään tykkää vaan.......... rakastan.... ❤️"           // Secret hover message
        },
        second: {
            text: "Kuinka paljon rakastat minua..:3",                          // For the love meter
            startText: "Näin paljon!!!",                                   // Text before the percentage
            nextBtn: "seuraava ❤️"                                         // Text for the next button
        },
        third: {
            text: "Olisitko ystävänpäiväheilani vuonna 2026, Stiinani??  🌹", // The big question!
            yesBtn: "OLISIN!",                                             // Text for "Yes" button
            noBtn: "En.."                                                 // Text for "No" button
        }
    },
